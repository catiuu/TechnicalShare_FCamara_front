...
const errorMsgs = {
  email: {
    valueMissing:
      '<img src="/images/error.svg" alt="" aria-hidden="true"> Insira seu E-mail Corporativo.',
    typeMismatch:
      '<img src="/images/error.svg" alt="" aria-hidden="true"> O email digitado não é válido.'
  },
  pass: {
    valueMissing:
      '<img src="/images/error.svg" alt="" aria-hidden="true"> Insira sua Senha.'
    // patternMismatch:
